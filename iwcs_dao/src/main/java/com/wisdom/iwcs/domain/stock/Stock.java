...
public class Stock {
     ...
     * 设置盘点标识，0否，1是
     *
     * @param invStat 盘点标识，0否，1是
     */
    public void setInvStat(String invStat) {
        this.invStat = invStat == null ? null : invStat.trim();
    }

    /**
     * 获取上次盘点日期
     *
     * @return last_inv_date - 上次盘点日期
     */
     ...
     * 获取最近入库时间
     *
     * @return date_last_pm - 最近入库时间
     */
    public Date getDateLastPm() {
        return dateLastPm;
    }
     ...
     * 设置最近入库时间
     *
     * @param dateLastPm 最近入库时间
     */
    public void setDateLastPm(Date dateLastPm) {
        this.dateLastPm = dateLastPm;
    }

    /**
     * 获取最近出库时间
     *
     * @return date_last_rm - 最近出库时间
     */
    public Date getDateLastRm() {
        return dateLastRm;
    }
     ...
     * 设置最近出库时间
     *
     * @param dateLastRm 最近出库时间
     */
    public void setDateLastRm(Date dateLastRm) {
        this.dateLastRm = dateLastRm;
    }
