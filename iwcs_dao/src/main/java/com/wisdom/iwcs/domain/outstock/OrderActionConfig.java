...
public class OrderActionConfig {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderActionConfig)) return false;
        OrderActionConfig that = (OrderActionConfig) o;
        return Objects.equals(configCode, that.configCode);
    }

    @Override
    public int hashCode() {

        return Objects.hash(configCode);
    }
