...
import static com.wisdom.iwcs.common.utils.TaskConstants.bizProcess.ENTER_ALLOW_LEAVE_IN_WAIT;


/**
 * 进围栏等待关门时,继续Hik任务的前置条件
 * @author han
 */
@Component
public class EnterWaitCloseHandler implements IConditionHandler {
    @Autowired
    ...
    public boolean handleCondition(SubTaskCondition subTaskCondition) {
        ...
        return ENTER_ALLOW_LEAVE_IN_WAIT.equals(mainTask.getBizProcess());
    }
