...
import static com.wisdom.iwcs.common.utils.TaskConstants.bizProcess.ENTER_ARRIVED_OUT;


/**
 * 进围栏到达围栏外等待点时,通知MES开门的前置条件
 * @author han
 */
@Component
public class EnterArrivedOutWaitHandler implements IConditionHandler {
    @Autowired
    ...
    public boolean handleCondition(SubTaskCondition subTaskCondition) {
        ...
        return ENTER_ARRIVED_OUT.equals(mainTask.getBizProcess()) || ENTER_ALLOW_LEAVE_OUT_WAIT.equals(mainTask.getBizProcess());
    }
