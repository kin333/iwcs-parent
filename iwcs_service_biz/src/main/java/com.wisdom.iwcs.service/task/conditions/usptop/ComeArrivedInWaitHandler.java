...
import static com.wisdom.iwcs.common.utils.TaskConstants.bizProcess.COME_ALLOW_LEAVE_IN_WAIT;
import static com.wisdom.iwcs.common.utils.TaskConstants.bizProcess.COME_ARRIVED_IN;


/**
 * 出围栏到达围栏内等待点时,通知MES开门的前置条件
 * @author han
 */
@Component
public class ComeArrivedInWaitHandler implements IConditionHandler {
    @Autowired
    ...
    public boolean handleCondition(SubTaskCondition subTaskCondition) {
        ...
        return COME_ARRIVED_IN.equals(mainTask.getBizProcess()) || COME_ALLOW_LEAVE_IN_WAIT.equals(mainTask.getBizProcess());
    }
