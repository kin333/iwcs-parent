 ...
 */
@Component
public class LeaveStartNotifyHandler implements IConditionHandler {
    @Autowired
    ...
    public boolean handleCondition(SubTaskCondition subTaskCondition) {
        ...
        //如果主任务状态在: 离开起点,入围栏到达围栏外等待点,出围栏到达围栏内等待点  时,可发送离开起点通知
        return TASK_LEAVE.equals(mainTask.getBizProcess()) || ENTER_ARRIVED_OUT.equals(mainTask.getBizProcess())
                || COME_ARRIVED_IN.equals(mainTask.getBizProcess());
    }
